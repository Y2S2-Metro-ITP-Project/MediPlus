...
export default function DashBooking() {
  ...
  const sendEmail = async () => {
    ...
    try {
      ...
      const emailContent = `
        ...
        Here are the details of your upcoming appointment:<h3 style="color: #4CAF50; font-family:'Roboto', sans-serif;">Appointment Details</h3>
  ...
  const handleExamineBooking = async (booking) => {
    ...
    try {
      const res = await fetch(`/api/booking/updateStatus/${booking._id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
